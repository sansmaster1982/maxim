...
- [ ] **Этап 6 — Заливка на GitHub.** Репозиторий готов (ветка `main`, чистое дерево, 8 коммитов). Нужен `gh auth login` или `GH_TOKEN` — действие пользователя. Точные шаги: [docs/GITHUB.md](docs/GITHUB.md).
